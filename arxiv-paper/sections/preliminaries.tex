...
\ref{lem:cardinality} shows why exact representation of all real numbers using countable fractal dimensions is impossible. This motivates our focus on approximation.
