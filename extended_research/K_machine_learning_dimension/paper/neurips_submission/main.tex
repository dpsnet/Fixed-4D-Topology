...
\author{%
  Wang Bin$^{1}$ \and Kimi 2.5 Agent$^{2}$ \\[0.3em]
  \small $^{1}$Independent Researcher, wang.bin@foxmail.com \\[0.2em]
...
\textbf{Wang Bin}: Conceptualization, research direction, hypothesis generation, physical intuition, final decisions within capability limits.
