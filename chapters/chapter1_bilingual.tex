...
\textbf{[En]} This has led to the concept of \emph{spectral dimension flow}, where the effective dimensionality of spacetime varies with the energy scale of observation.
...
% 句子16
\item \textbf{[中]} 第 \ref{sec:foundations} 节介绍理论基础。

\textbf{[En]} Section \ref{sec:foundations} presents the theoretical foundations.

% 句子17
\item \textbf{[中]} 第 \ref{sec:correspondence} 节讨论三系统对应关系。

\textbf{[En]} Section \ref{sec:correspondence} discusses the three-system correspondence.

% 句子18
\item \textbf{[中]} 第 \ref{sec:experiments} 节回顾实验验证。

\textbf{[En]} Section \ref{sec:experiments} reviews experimental validations.

% 句子19
\item \textbf{[中]} 第 \ref{sec:applications} 节探索物理应用。

\textbf{[En]} Section \ref{sec:applications} explores physical applications.
