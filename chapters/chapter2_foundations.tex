...
For a smooth $d$-dimensional manifold without boundary, in the limit $\tau \to 0$, we recover $d_s = d$. However, in quantum gravity scenarios, different elements of the quantum spacetime ensemble (or the same system at different internal scales) may exhibit different effective dimensions, reflected in the non-trivial scale dependence of $d_s(\tau)$.
