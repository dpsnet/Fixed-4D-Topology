...
However, the question of dimension becomes problematic at the quantum scale. At distances comparable to the Planck length $\ell_P \approx 1.6 \times 10^{-35}$ m, the smooth manifold description of classical spacetime breaks down, and quantum fluctuations dominate. This has led to the concept of \emph{constraint-determined effective dimension}, where different quantum spacetime configurations (or the same system with different internal constraint strengths) exhibit different effective dimensionalities.
