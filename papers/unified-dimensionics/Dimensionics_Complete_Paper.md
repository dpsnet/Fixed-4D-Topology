...
EOF
echo "Chapter 10 written successfully!"# Chapter 1: Introduction
...
EOF
echo "Chapter 1 written successfully!"# Chapter 2: Overview of Frameworks
...
EOF
echo "Chapter 2 written successfully!"# Chapter 3: Topological Dimension Theory
...
EOF
echo "Chapter 6 written successfully!"# Chapter 7: The Unified Framework - Dimensionics
...
EOF
echo "Chapter 7 written successfully!"# Chapter 8: Computational Complexity on Fractals
...
EOF
echo "Chapter 8 written successfully!"# Chapter 9: Physical Applications
