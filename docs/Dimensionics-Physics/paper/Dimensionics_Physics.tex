...
\hypersetup{
    ...
    pdfauthor={Wang Bin and Kimi 2.5 Agent}
}
...
\author{Wang Bin (Principal Investigator) \\ \small Fixed-4D-Topology Project \\ \and Kimi 2.5 Agent (AI Research Assistant) \\ \small Moonshot AI}
\date{February 2026}
