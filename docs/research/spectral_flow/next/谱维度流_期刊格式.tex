...
\begin{center}
{\LARGE\bfseries 谱维度流在引力系统中的研究}\\[0.5em]
{\large\bfseries Spectral Dimension Flow in Gravitational Systems}\\[1.5em]
...
\small
\textbf{摘要：}本文对跨越多个引力尺度的谱维度流进行了全面研究，从微观黑洞到宇宙学视界。我们的统一框架表明，谱维度 $d_s$ 在短距离处从 $d_s \approx 2$ 特征性地过渡到宏观尺度的 $d_s = 4$。通过对包含2000个双曲3-流形的SnapPy普查数据进行广泛的数值分析，我们提取出普适系数 $c_1 = 0.245 \pm 0.014$，与理论预测 $c_1 = 1/4$ 精确吻合。将我们的框架应用于LIGO/Virgo合作组织的引力波数据，产生贝叶斯因子 $B = 9.0 \pm 4.5$ 支持谱流假设。宇宙学意义包括具有特征振荡特征的原始引力波谱，可在特征频率 $f \approx 0.3$ mHz处被下一代探测器（如LISA）观测到。

\textbf{关键词：}谱维度；量子引力；引力波；双曲几何

\vspace{0.5em}
\textbf{Abstract:} We present a comprehensive investigation of spectral dimension flow across multiple gravitational regimes. Our unified framework demonstrates that the spectral dimension $d_s$ undergoes a characteristic transition from $d_s \approx 2$ at short distances to $d_s = 4$ at large scales. Through numerical analysis of 2,000 hyperbolic 3-manifolds, we extract $c_1 = 0.245 \pm 0.014$, in precise agreement with the theoretical prediction $c_1 = 1/4$.

\textbf{Keywords:} Spectral dimension; Quantum gravity; Gravitational waves; Hyperbolic geometry
}}
\end{center}
...
广义相对论与量子力学的调和仍然是理论物理学中最深刻的挑战之一。这一挑战的核心是普朗克尺度下的时空结构问题。

众多理论方法已经解决了这个问题，每种方法都提供了独特的见解。\textbf{弦理论}在微扰表述中，基本弦在可与弦长相比的尺度上探测时空。\textbf{圈量子引力}这种非微扰方法直接量子化几何。\textbf{渐近安全}情景下引力的重整化群流预测了一个非高斯固定点。\textbf{因果动态三角化}提供了维度降低的确凿证据。
...
SnapPy普查提供了具有计算几何不变量的双曲3-流形的综合集合。如表~\ref{tab:c1}所示。
...
我们的结果为跨多种量子引力框架的维度降低提供了统一视角。主要发现包括：
\begin{enumerate}
...
\begin{thebibliography}{10}
    ...
    \bibitem{bib6} 王斌, Kimi 2.5 Agent. 谱维度流研究[J]. 物理学报, 2026.
\end{thebibliography}
